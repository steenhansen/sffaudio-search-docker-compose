...
"HELP_ALL" : [ {"id": 900, "group":"I_HELP", "node_type":"HELP_ALL", ${help_font}, "label":"Help" },
               {"id": 901, "group":"L_AUTHOR", "node_type":"HELP_AUTHOR", "title":"Click for author help"},
               {"id": 902, "group":"L_BOOK", "node_type":"HELP_BOOK", "title":"Click for book help"},
               {"id": 903, "group":"L_PDF", "node_type":"HELP_PDF", "title":"Click for pdf help"},
               {"id": 904, "group":"L_AUTHOR_POST", "node_type":"HELP_AUTHOR_POST", "title":"Click for author post help"},
               {"id": 905, "group":"L_RSD", "node_type":"HELP_RSD", "title":"Click for RSD help"},
               {"id": 906, "group":"L_PODCAST", "node_type":"HELP_PODCAST", "title":"Click for podcast help"},
               {"id": 907, "group":"L_BOOK_WIKI", "node_type":"HELP_BOOK_WIKI", "title":"Click for Wikipedia help"},
               {"id": 908, "group":"I_GROW", "node_type":"HELP_GROW", "title":"Click for zoom in help"},         
               {"id": 909, "group":"I_FILTER", "node_type":"HELP_FILTER", "title":"Click for filter help"},
               {"id": 910, "group":"I_SHRINK", "node_type":"HELP_SHRINK", "title":"Click for zoom out help"},
               {"id": 911, "group":"I_ARROW", "node_type":"HELP_ARROW", "title":"Click for drag help"}          ],
