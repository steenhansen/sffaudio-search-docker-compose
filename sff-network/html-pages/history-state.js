...
function typeSortedChoiceFindFactory(_node_type, _sorted_choice){
    ...
    my.popViewPdf=function(sorted_choice){
       var findPdfChoice = typeSortedChoiceFindFactory('N_PDF', sorted_choice);
                   var pdf_view = sff_js_vars.graph_vars.nodes_string.find(findPdfChoice);         //             http://localhost:5000/?book=beyond_lies_the_wub&author=philip_k_dick&view=pdf
    ...
    my.popPostViewBook=function(sorted_choice){
         var findBookChoice = typeSortedChoiceFindFactory('N_BOOK_POST', sorted_choice);
                    var book_view = sff_js_vars.graph_vars.nodes_string.find(findBookChoice);         //             http://localhost:5000/?book=beyond_lies_the_wub&author=philip_k_dick&view=pdf
    ...
    my.popRsdView=function(sorted_choice){
         ...
         var rsd_view = sff_js_vars.graph_vars.nodes_string.find(findRsdChoice);         //             http://localhost:5000/?book=beyond_lies_the_wub&author=philip_k_dick&view=pdf
    ...
    my.popViewPodcast=function(sorted_choice){
        ...
        var podcast_view = sff_js_vars.graph_vars.nodes_string.find(findPodcastChoice);         //             http://localhost:5000/?book=beyond_lies_the_wub&author=philip_k_dick&view=pdf
