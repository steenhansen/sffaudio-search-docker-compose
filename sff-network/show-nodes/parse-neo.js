...
module.exports = function (graph_repository) {
    var nodeFactory = rootAppRequire('./sff-network/show-nodes/node-factory')(graph_repository)
    var AuthorNode = rootAppRequire('sff-network/show-nodes/media-types/author-show')(graph_repository)
    var BookData = rootAppRequire('sff-network/show-nodes/media-types/book-show')(graph_repository)
