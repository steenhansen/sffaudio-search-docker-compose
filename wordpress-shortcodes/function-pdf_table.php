...
function lame_php_redirect_pdf($location){
...
function longMobileTest_pdf($location){
  if (strpos ($_SERVER['HTTP_USER_AGENT'], '(iPad;')) {
	...
	lame_php_redirect_pdf($location);
    }
}

function shortMobileTest_pdf($location){
