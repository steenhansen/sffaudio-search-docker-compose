...
//console.log('currentDbVersion -- graph_db ==', graph_db)
//console.log('currentDbVersion -- graph_db.sqlParams ==', graph_db.sqlParams)

//graph_db.sqlParams(current_sql, {})
//.then( (answer)=> console.log('answer', answer));

//console.log('currentDbVersion --  graph_db.sqlParams(current_sql, {}) ==',  graph_db.sqlParams(current_sql, {}))
